...
import { updateLibroUsuario, addLibroUsuario, getLibrosUsuario, delLibroUsuario, getLibroUsuario } from '../controllers/libros-usuarios.controllers.js';
...
router.get('/librosUsuario/:id_libro/:id_usuario', autenticarToken, getLibroUsuario); // Obtiene un libro de un usuario por ID 
