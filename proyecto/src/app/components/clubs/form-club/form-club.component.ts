      ...
      this.servicioClubs.actualizarClub(datos).subscribe({
        next: () => {
          Swal.fire({
            ...
            position: 'top-start',
            icon: 'success',
            title: this.translate.instant('club.actualizado_exito'),
        ...
        error: (err) => {
          Swal.fire({
            ...
            position: 'top-start',
            icon: 'error',
            title: this.translate.instant('club.actualizado_error'),
            showConfirmButton: false,
            timer: 3000,
            timerProgressBar: true,
          });
      ...
      this.servicioClubs.crearClub(datos).subscribe({
        next: (nuevoClub) => {
          Swal.fire({
            ...
            position: 'top-start',
            icon: 'success',
            title: this.translate.instant('club.creado_exito'),
            showConfirmButton: false,
            timer: 3000,
            timerProgressBar: true,
          });
        ...
        error: (err) => {
          Swal.fire({
            ...
            position: 'top-start',
            icon: 'error',
            title: this.translate.instant('club.creado_error'),
            showConfirmButton: false,
            timer: 3000,
            timerProgressBar: true,
          });
